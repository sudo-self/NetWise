...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import("./_nuxt/multipart-parser-cr9kD0Va.js");
...
const _routes = [
  {
    name: "DeviconVuejs",
    path: "/DeviconVuejs",
    component: () => import("./_nuxt/DeviconVuejs-9-IhNQXm.js")
  },
  {
    name: "DNSlookup",
    path: "/DNSlookup",
    component: () => import("./_nuxt/DNSlookup-S0MaH3SQ.js")
  },
  {
    name: "FloatingButton",
    path: "/FloatingButton",
    component: () => import("./_nuxt/FloatingButton-DJU-RFt0.js")
  },
  {
    name: "GameIconsOwl",
    path: "/GameIconsOwl",
    component: () => import("./_nuxt/GameIconsOwl-06nz0xij.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DSreT1lz.js")
  },
  {
    name: "ip-toolkit",
    path: "/ip-toolkit",
    component: () => import("./_nuxt/ip-toolkit-CmVAB7Ii.js")
  },
  {
    name: "MacAddress",
    path: "/MacAddress",
    component: () => import("./_nuxt/MacAddress-0So0vzSz.js")
  },
  {
    name: "Ping",
    path: "/Ping",
    component: () => import("./_nuxt/Ping-BI_2cYTc.js")
  },
  {
    name: "StatusCodes",
    path: "/StatusCodes",
    component: () => import("./_nuxt/StatusCodes-C50ZwMeE.js")
  },
  {
    name: "WifiToolkit",
    path: "/WifiToolkit",
    component: () => import("./_nuxt/WifiToolkit-BczDfwBB.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CZ9czbWS.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CnOZfN60.js"));
