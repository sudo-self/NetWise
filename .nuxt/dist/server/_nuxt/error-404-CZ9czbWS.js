...
import { u as useRouter, p as parseQuery, n as nuxtLinkDefaults, h as hasProtocol, r as resolveRouteObject, j as joinURL, a as navigateTo, b as useNuxtApp, c as useRuntimeConfig, w as withTrailingSlash, d as withoutTrailingSlash, _ as _export_sfc } from "../server.mjs";
import "hookable";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent } from "vue/server-renderer";
import { u as useHead } from "./vue.8fc199ce-DerijIML.js";
import "node:http";
import "node:https";
import "node:zlib";
import "node:stream";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-b0327eac><div class="fixed left-0 right-0 spotlight z-10" data-v-b0327eac></div><div class="max-w-520px text-center z-20" data-v-b0327eac><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-b0327eac>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-b0327eac>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-b0327eac>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.4.1_@types+node@22.7.4_ioredis@5.4.1_magicast@0.3.5_rollup@4.24_2k7m6tt7b46bgsxaiirz4m7r34/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b0327eac"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-CZ9czbWS.js.map
