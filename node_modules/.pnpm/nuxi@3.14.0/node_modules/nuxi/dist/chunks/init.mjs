...
import fs__default, { existsSync, readdirSync as readdirSync$1, createWriteStream } from 'node:fs';
...
import require$$0$d from 'fs';
import require$$5$3 from 'process';
import require$$0$e from 'util';
import require$$1$6 from 'crypto';
import { d as defu } from '../shared/nuxi.eaa29140.mjs';
import { i as installDependencies } from '../shared/nuxi.49187e3d.mjs';
import me$1, { pipeline as pipeline$3 } from 'node:stream';
import { spawnSync } from 'node:child_process';
import os, { homedir } from 'node:os';
import require$$8$2, { promisify as promisify$3 } from 'node:util';
...
import require$$8$3 from 'node:buffer';
...
const { isAbsolute, parse: parse$3 } = sysPath__default.win32;
...
const { promisify: promisify$2 } = require$$0$e;
const fs$6 = require$$0$d;
...
const { resolve, parse: parse$1 } = sysPath__default;
...
const {dirname: dirname$2} = sysPath__default;
...
const {dirname: dirname$1} = sysPath__default;
...
const fs$2 = commonjsGlobal$1.__FAKE_TESTING_FS__ || require$$0$d;
