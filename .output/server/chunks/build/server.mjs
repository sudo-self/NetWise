...
import { m as sanitizeStatusCode, n as createHooks, i as createError$1, t as toRouteMatcher, o as createRouter$1 } from '../runtime.mjs';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-cr9kD0Va.mjs');
...
const unhead_pfaFQqsLN8 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "DeviconVuejs",
    path: "/DeviconVuejs",
    component: () => import('./DeviconVuejs-9-IhNQXm.mjs')
  },
  {
    name: "DNSlookup",
    path: "/DNSlookup",
    component: () => import('./DNSlookup-S0MaH3SQ.mjs')
  },
  {
    name: "FloatingButton",
    path: "/FloatingButton",
  ...
  },
  {
    name: "GameIconsOwl",
    path: "/GameIconsOwl",
    component: () => import('./GameIconsOwl-06nz0xij.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    name: "ip-toolkit",
    path: "/ip-toolkit",
    component: () => import('./ip-toolkit-CmVAB7Ii.mjs')
  },
  {
    name: "MacAddress",
    path: "/MacAddress",
    component: () => import('./MacAddress-0So0vzSz.mjs')
  },
  {
    name: "Ping",
    path: "/Ping",
  ...
  },
  {
    name: "StatusCodes",
    path: "/StatusCodes",
    component: () => import('./StatusCodes-C50ZwMeE.mjs')
  },
  {
    name: "WifiToolkit",
    path: "/WifiToolkit",
    component: () => import('./WifiToolkit-BczDfwBB.mjs')
  }
];
...
const revive_payload_server_HVDUv6TwQb = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_pfaFQqsLN8,
  plugin,
  revive_payload_server_HVDUv6TwQb,
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.4.1_@types+node@22.7.4_ioredis@5.4.1_magicast@0.3.5_rollup@4.24_2k7m6tt7b46bgsxaiirz4m7r34/node_modules/nuxt/dist/pages/runtime/app.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CZ9czbWS.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CnOZfN60.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.4.1_@types+node@22.7.4_ioredis@5.4.1_magicast@0.3.5_rollup@4.24_2k7m6tt7b46bgsxaiirz4m7r34/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.4.1_@types+node@22.7.4_ioredis@5.4.1_magicast@0.3.5_rollup@4.24_2k7m6tt7b46bgsxaiirz4m7r34/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { On as O, _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, withoutTrailingSlash as d, entry$1 as default, resolveUnrefHeadInput as e, br as f, hasProtocol as h, injectHead as i, joinURL as j, nuxtLinkDefaults as n, parseQuery as p, resolveRouteObject as r, useRouter as u, withTrailingSlash as w };
