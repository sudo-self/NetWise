...
const _sfc_main = {
  ...
  methods: {
    ...
    handleMouseDown(event) {
      ...
      (void 0).addEventListener("touchmove", this.onDrag, { passive: false });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-4236f7ed><div class="tooltip-container" data-v-4236f7ed><button class="floating-button" style="${ssrRenderStyle({ backgroundImage: `url(${$data.buttonImage})` })}" data-v-4236f7ed><span class="tooltip" data-v-4236f7ed>Speed Test</span></button></div>`);
  if ($data.showPopup) {
    _push(`<div class="popup" data-v-4236f7ed><div class="popup-content" data-v-4236f7ed><iframe src="https://Fast.com" class="popup-iframe" frameborder="0" data-v-4236f7ed></iframe></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div>`);
...
const FloatingButton = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4236f7ed"]]);

export { FloatingButton as default };
//# sourceMappingURL=FloatingButton-D_7VHFKp.mjs.map
